...
There are many other features of Shiny that can make your app more interesting, but we will finish it here for the part one of our exploration. Full code of the app demonstrated here can be found in the [GitHub Page](https://github.com/NabiilahArdini/Shiny-Box). Please look forward to the next article that will be focused on exploring the reactive mechanism, inputs and outputs of Shiny. Until later!