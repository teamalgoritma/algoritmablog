...
<center> ![](/img/optics/OPTICS_SEarch_Distance.PNG){width="80%"} </center>
...
<center> ![](/img/optics/Reachability_Plot.PNG){width="80%"} </center>
...
<center> ![](/img/optics/ilustrasi_lembah_puncak.PNG){width="80%"} </center>
...
<center> ![](/img/optics/sensitivity.JPG){width="80%"} </center>
...
<center> ![](/img/optics/dbscan.JPG){width="80%"} </center>
...
<center> ![](/img/optics/optics.JPG){width="80%"} </center>
