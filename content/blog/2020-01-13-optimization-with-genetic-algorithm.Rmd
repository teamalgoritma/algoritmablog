...
knitr::include_graphics("/genetic-algo/nonconvex.png")
```

The general flow of the algorithm is shown below:

```{r out.width="30%", echo=FALSE, eval =TRUE}
knitr::include_graphics("/genetic-algo/ga_flow.png")
```
...
knitr::include_graphics("/genetic-algo/ga_element.png")
```
...
![Nearchou, 2014](/genetic-algo/ga6.png)
...
![Nearchou, 2014](/genetic-algo/pb_cross.png)
...
![](/genetic-algo/gabin_mutation.png)
...
```{r out.width="50%", echo=FALSE, eval =TRUE}
knitr::include_graphics("/genetic-algo/step7.png")
```
